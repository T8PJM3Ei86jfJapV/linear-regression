...
dimension = 384
caseNum = 0
theta = [1 for i in range(dimension + 1)]
items = list()
featureRange = list()
featureMean = list()
...
def main():
    ...
    fout = open('scaling_factors.txt', 'a')
    fout.write('featureRange: ' + str(featureRange) + '\n')
    fout.write('featureMean: ' + str(featureMean) + '\n')
    fout.close()
